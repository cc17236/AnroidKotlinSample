 ...
 */
abstract class BaseInfo1<T> : Serializable, MultiItemEntity {
    ...
    abstract var defaultObject: T

    class BaseInfoImpl : BaseInfo1<BaseInfoImpl>() {
        override var defaultObject = BaseInfoImpl()
    }
}