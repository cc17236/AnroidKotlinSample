...
class AppUtils private constructor() {
    ...
    companion object {
        ...
        fun installAppSilent(filePath: String): Boolean {
            ...
            return commandResult?.successMsg != null && commandResult.successMsg?.toLowerCase()?.contains("success")==false
        }
         ...
         */
        @JvmOverloads
        fun getAppDetailsSettings(packageName: String = Utils.getContext().packageName) {
            if (isSpace(packageName)) return
         ...
         */
        fun cleanAppData( dirPaths: Array<String?>): Boolean {
