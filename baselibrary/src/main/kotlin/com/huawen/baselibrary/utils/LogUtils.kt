...
class LogUtils private constructor() {
        ...
        init {
            if (defaultDir != null){
                ...
                if (Environment.MEDIA_MOUNTED == Environment.getExternalStorageState() && Utils.getContext().externalCacheDir != null)
                    defaultDir = Utils.getContext().externalCacheDir.toString() + FILE_SEP + "log" + FILE_SEP
                else {
                    defaultDir = Utils.getContext().cacheDir.toString() + FILE_SEP + "log" + FILE_SEP
                }
            }
    ...
    companion object {
       ...
       const val V = Log.VERBOSE
        ...
        private fun processTagAndHead(tag_: String?): Array<String> {
            var tag = tag_?:""
