...
class ActivityUtils private constructor() {
    ...
    companion object {
         ...
         * @param cls      activity类
         */
        fun startActivity(extras: Bundle, activity: Activity, cls: Class<*>) {
         ...
         * @param exitAnim  出场动画
         */
        fun startActivity(activity: Activity, cls: Class<*>, enterAnim: Int, exitAnim: Int) {
            startActivity(activity, null, activity.packageName, cls.name, null)
         ...
         * @param exitAnim  出场动画
         */
        fun startActivity(extras: Bundle, activity: Activity, cls: Class<*>, enterAnim: Int, exitAnim: Int) {
            startActivity(activity, extras, activity.packageName, cls.name, null)
            activity.overridePendingTransition(enterAnim, exitAnim)
        }
         ...
         * @param options  跳转动画
         */
        fun startActivity(activity: Activity, cls: Class<*>, options: Bundle) {
         ...
         * @param options  跳转动画
         */
        fun startActivity(extras: Bundle, activity: Activity, cls: Class<*>, options: Bundle) {
         ...
         * @param cls    全类名
         */
        fun startActivity(extras: Bundle, pkg: String, cls: String) {
         ...
         * @param options 动画
         */
        fun startActivity(pkg: String, cls: String, options: Bundle) {
         ...
         * @param options 动画
         */
        fun startActivity(extras: Bundle, pkg: String, cls: String, options: Bundle) {
