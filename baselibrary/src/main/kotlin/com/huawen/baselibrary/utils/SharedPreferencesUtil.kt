...
class SharedPreferencesUtil private constructor() {
    ...
    companion object {
        fun outer(context: Context, prefsname: String, mode: Int): SharedPreferencesUtil {
            val utils = SharedPreferencesUtil()
            utils.context = context
            utils.prefs = context.getSharedPreferences(prefsname, mode)
