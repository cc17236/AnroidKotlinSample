package com.huawen.baselibrary.adapter.callback
...
import com.huawen.baselibrary.adapter.BaseItemDraggableAdapter
import com.huawen.baselibrary.adapter.BaseQuickAdapter

/**
 * Created by luoxw on 2016/6/20.
 */
class ItemDragAndSwipeCallback(
    //    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();

    private val mAdapter: BaseItemDraggableAdapter<*, *>
    ...
    override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.BaseQuickAdapter_dragging_support) != null && viewHolder.itemView.getTag(R.id.BaseQuickAdapter_dragging_support) as Boolean) {
            mAdapter.onItemDragEnd(viewHolder)
            viewHolder.itemView.setTag(R.id.BaseQuickAdapter_dragging_support, false)
        }
        if (viewHolder.itemView.getTag(R.id.BaseQuickAdapter_swiping_support) != null && viewHolder.itemView.getTag(R.id.BaseQuickAdapter_swiping_support) as Boolean) {
