...
abstract class BottomNavigationTab extends FrameLayout {
    ...
    public void setNavigationHeight(int height) {
        if (containerView != null) {
            containerView.getLayoutParams().height = height;
        }
    }
    ...
    public void select(boolean setActiveColor, int animationDuration) {
        ...
        if (activeTextSize>0){
            labelView.setTextSize(activeTextSize);
        }
        if (badgeItem != null) {
            badgeItem.select();
        }
    ...
    public void unSelect(boolean setActiveColor, int animationDuration) {
        ...
        if (inactiveTextSize>0){
            labelView.setTextSize(inactiveTextSize);
        }
    ...
    public void setInactiveTextSize(int inactive) {
        if (inactive > 0) {
            inactiveTextSize=inactive;
            if (labelView!=null){
                if (!isActive){
                    labelView.setTextSize(inactiveTextSize);
                }
    ...
    private int inactiveTextSize=0;
    private int activeTextSize=0;

    public void setActiveTextSize(int active) {
        if (active > 0) {
            activeTextSize=active;
            if (labelView!=null){
                if (isActive){
                    labelView.setTextSize(activeTextSize);
                }
