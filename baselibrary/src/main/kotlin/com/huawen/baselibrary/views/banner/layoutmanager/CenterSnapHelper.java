package com.huawen.baselibrary.views.banner.layoutmanager;
...
//            if (layoutManager.isFling) {
//                offsetPosition = (int) (mGravityScroller.getFinalX() / layoutManager.mInterval / layoutManager.getDistanceRatio());
//            }
//            mRecyclerView.smoothScrollToPosition(layoutManager.getReverseLayout() ? currentPosition - offsetPosition : currentPosition + offsetPosition);
