...
class BottomNavigationHelper {
    ...
    static void bindTabWithData(BottomNavigationItem bottomNavigationItem, BottomNavigationTab bottomNavigationTab, BottomNavigationBar bottomNavigationBar) {
        ...
        if (bottomNavigationItem.isInActiveTextSizeAvailable()) {
            int inactive = bottomNavigationItem.getTextSize(true);
            int active = bottomNavigationItem.getTextSize(false);
            bottomNavigationTab.setInactiveTextSize(inactive);
            bottomNavigationTab.setActiveTextSize(active);
        }
