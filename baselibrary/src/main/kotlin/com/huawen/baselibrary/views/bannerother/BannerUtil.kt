package com.huawen.baselibrary.views.bannerother
...
import com.huawen.baselibrary.views.bannerother.banner.LBannerLayoutManager
import com.huawen.baselibrary.views.bannerother.banner.OnSelectedListener
import com.huawen.baselibrary.views.bannerother.banner.Orientation
import com.huawen.baselibrary.views.bannerother.banner.ScrollState
...
class BannerUtil private constructor(private val recyclerView: RecyclerView):
    ...
    fun nextPosition(): BannerUtil {
        ...
        }else if(position >= (recyclerView.adapter?.itemCount?:0)){
