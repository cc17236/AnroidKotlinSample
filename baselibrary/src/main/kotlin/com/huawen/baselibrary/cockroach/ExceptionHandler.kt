...
abstract class ExceptionHandler {
    ...
    protected var sDefaultUncaughtExceptionHandler: Thread.UncaughtExceptionHandler? = null


    internal fun uncaughtExceptionHappened(thread: Thread, throwable: Throwable) {
    ...
    internal fun bandageExceptionHappened(throwable: Throwable) {
        try {//捕获监听中异常，防止使用方代码抛出异常时导致的反复调用
    ...
    internal fun enterSafeMode() {
     ...
     internal fun mayBeBlackScreen(e: Throwable) {
        try {
    ...
    open fun onMayBeBlackScreen(e: Throwable) {
